 ...
 * @Last Modified time: 2026-05-03 21:13:40
*/
// 2026-02-01: Aggiunto locale
// 2026-05-03: Aggiunto campo note
...
if ($component_id > 0) {
  ...
  $stmt = $pdo->prepare("SELECT c.id, c.codice_prodotto, c.quantity, c.unita_misura, c.notes, cat.name AS category_name, l.name AS location_name, loc.name AS locale_name, cmp.code AS compartment_code
      FROM components c
              ...
              <div class="row g-3 mb-3">
                <div class="col-12">
                  ...
                  <div class="border rounded p-1 bg-light">
                    <div style="white-space: pre-wrap;"><?= htmlspecialchars($component['notes']) ?></div>
                  </div>
                </div>
              </div>
            <?php endif; ?>
