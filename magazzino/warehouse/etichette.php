 ...
 * @Last Modified time: 2026-02-19 15:30:58
*/
// Pagina per la generazione di etichette personalizzate
...
<div class="container py-4">
	<div class="d-flex justify-content-between align-items-center mb-3">
		<h2><i class="fa-solid fa-tags me-2"></i>Genera Etichette</h2>
		<a href="<?= BASE_PATH ?>warehouse/components.php" class="btn btn-secondary">Torna a componenti</a>
	</div>

	<div class="card" style="max-width:900px;">
		<div class="card-body">
			<form id="etichetteForm" method="post" action="generate_etichette.php" target="_blank">
				<div class="row g-3">
					<div class="col-md-6">
					...
					<div class="col-12">
						...
						<div class="form-check">
							...
							<label class="form-check-label" for="include_code_under_barcode">Mostra il codice del prodotto sotto (opzionale)</label>
						</div>
					</div>

					<div class="col-12 text-end">
						<button id="generateBtn" type="submit" class="btn btn-primary" disabled>Genera Etichette</button>
					</div>
				</div>
			</form>
		</div>
...
<div class="container mt-4" style="max-width:900px;">
	<div class="alert alert-info">
		<h6 class="alert-heading"><i class="fas fa-info-circle me-2"></i>Come utilizzare le Etichette</h6>
		<small>
			Le etichette vengono utilizzate per identificare e organizzare i componenti nel magazzino.<br><br>
			<strong>Istruzioni per l'uso:</strong><br>
			1. <strong>Selezione componenti:</strong> scegli una posizione per filtrare i componenti, oppure seleziona manualmente quelli desiderati.<br>
			2. <strong>Generazione etichette:</strong> clicca su "Genera Etichette" per stampare o creare un PDF con tutte le etichette selezionate.<br>
		</small>
	</div>
</div>
...
$(function(){
	...
	// submit: apri generate_etichette.php in nuova finestra (target _blank)
	$('#etichetteForm').on('submit', function(e){
