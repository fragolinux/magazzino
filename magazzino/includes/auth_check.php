...
// 2026-02-19 aggiunto controllo per rilevare se esiste il file di configurazione del database prima di includerlo (serve per l'aggiornamento)
...
try {
    ...
    if (file_exists($dbConfigFile)) {
        ...
        // Non fare nulla, continua senza database
    }
