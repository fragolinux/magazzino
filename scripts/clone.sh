...
mkdir -p "$target_dir/magazzino/config"
if [[ -f "$root/magazzino/config/settings.php" ]]; then
  rsync -a "$root/magazzino/config/settings.php" "$target_dir/magazzino/config/settings.php"
fi
if [[ -f "$root/magazzino/config/database.php" ]]; then
  rsync -a "$root/magazzino/config/database.php" "$target_dir/magazzino/config/database.php"
fi
